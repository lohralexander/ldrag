...
def main():
    ...
    neo4j_uri = os.environ.get("NEO4J_URI", "neo4j+s://00ea04d7.databases.neo4j.io")
    neo4j_user = os.environ.get("NEO4J_USER", "neo4j")
    neo4j_password = os.environ.get("NEO4J_PASSWORD", "zDXSGXMyU3y1Vzt8Efs6MgwmTdlLM12cOGlMc38P22Q")
